...
1. Read `<CODEX_HOME>/skills/.system/skill-creator/SKILL.md` before structural changes.
...
5. Run:
   - `python <CODEX_HOME>/skills/.system/skill-creator/scripts/quick_validate.py <skill-dir>`
